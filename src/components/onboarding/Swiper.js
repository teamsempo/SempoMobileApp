 ...
 *
 * Taken from ---> https://rationalappdev.com/complete-guide-to-mobile-app-onboarding-with-react-native/
 */
        ...
        return (
            <View pointerEvents="box-none" style={[styles.buttonWrapper, styles.fullScreen]}>
                {lastScreen
                    ...
                    ? <Button buttonText={strings('OnboardingScreens.StartNow')} onPress={() => this.sendToApp()} />
                    // Or this one otherwise
                    : <Button buttonText={strings('TransferCompleteScreen.Continue')} onPress={() => this.swipe()} />
                }
            </View>
        );
    }
    ...
    render = ({ children } = this.props) => {
        return (
            <View style={[styles.container, styles.fullScreen]}>
                ...
                {/* Render pagination */}
                {this.props.paginationEnabled ? this.renderPagination() : null}
                {/* Render Continue or Done button */}
                {this.props.buttonEnabled ? this.renderButton() : null}
            </View>
        );
    }
}
